...
def automatics(query_list):
    ...
    # 微信公众号
    driver.find_element_by_name("account").send_keys("fj2269@cumc.columbia.edu")
    driver.find_element_by_name("password").clear()
    time.sleep(2)
    # 微信公众号密码
    driver.find_element_by_name("password").send_keys("Xiao19970523@")
...
for i in range(len(account)):
    ...
    if trademark == 1:
        query_list.append(account_id)
automatics(query_list)